...
class CarliniWagnerConstrainedAttackTargeted:
    _attackName = "CarliniWagnerConstrainedTargeted"
    def execute(self, modeldata: ModelData) -> PerturbedData:
        ...
        try:
            ...
            attack = CarliniL2Method(classifier=model, targeted=True, verbose=True, **config)
            start = time.time()
